 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = (seconds(deg, min, sec) * PI) / seconds(180, 0, 0).toDouble()
 ...
 */
fun travelMinutes(hoursDepart: Int, minutesDepart: Int, hoursArrive: Int, minutesArrive: Int): Int = (seconds(hoursArrive, minutesArrive, 0) - seconds(hoursDepart, minutesDepart, 0)) / 60
